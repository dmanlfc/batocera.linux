...
define BATOCERA_INITRAMFS_SM6115_EARLY_FIRMWARE
    ...
    cp $(ALLLINUXFIRMWARES_DIR)/qcom/qrb4210/* \
        $(INITRAMFS_DIR)/lib/firmware/qcom/qrb4210/
	cp $(ALLLINUXFIRMWARES_DIR)/qcom/a630_sqe.fw \
	    $(INITRAMFS_DIR)/lib/firmware/qcom/
	cp $(ALLLINUXFIRMWARES_DIR)/qcom/a630_gmu.bin \
	    $(INITRAMFS_DIR)/lib/firmware/qcom/
    cp -R $(BR2_EXTERNAL_BATOCERA_PATH)/board/batocera/qualcomm/sm6115/fsoverlay/lib/firmware/* \
        $(INITRAMFS_DIR)/lib/firmware/
endef
BATOCERA_INITRAMFS_PRE_INSTALL_TARGET_HOOKS += BATOCERA_INITRAMFS_SM6115_EARLY_FIRMWARE
endif
